-- Migration: Update submit_protest function to derive reference_type from submission_types
-- This maintains backward compatibility while using the junction table pattern
